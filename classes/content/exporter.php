 ...
 */
namespace mod_tresipuntaudio\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_tresipuntaudio.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[]  = new exportable_filearea(
            $this->get_context(),
            $this->get_component(),
            get_string('tresipuntaudiocontent', 'mod_tresipuntaudio'),

            // The files held in mod_tresipuntaudio are stored in the 'content' filearea, under itemid 0.
            'content',
            0,
